	...
	tinymce.create('tinymce.plugins.MediaPlugin', {
		...
		imgToObject : function(node, args) {
			...
			function addPlayer(video_src, poster_src) {
				...
				flashPlayer = editor.getParam('flash_video_player_url', self.convertUrl(self.url + '/OSplayer.swf'));
				if (flashPlayer) {
					...
					flashVars = editor.getParam('flash_video_player_flashvars', {movie : '$url', btncolor : '0x333333', accentcolor : '0x31b8e9', txtcolor : '0xdddddd', volume : '30', autoload: 'on', autoplay : 'off', showTitle : 'no', poster : '$poster'});
