...
<fieldset class="radio_group">
 ...
 <span class="radio_option" onclick="toggle_checkbox('required_yes', 'check');saveField('<? echo $_REQUEST['field_id']; ?>', 'required', radiovalue('properties_form', 'required_yesno'));">
  <span class="props-titletxt">Yes</span>
  <input type="radio" name="required_yesno" id="required_yes" value="yes"<? echo $selectedyes; ?>/>
 </span>

 <span class="radio_option" onclick="toggle_checkbox('required_no', 'check');saveField('<? echo $_REQUEST['field_id']; ?>', 'required', radiovalue('properties_form', 'required_yesno'));">
...
//      $disHTML .= "<fieldset>\n";
      ...
      $disHTML .= " <input type=\"text\" id=\"field_width\" value=\"".$getField['width']."\" onblur=\"saveStyle('".$_REQUEST['field_id']."', 'height', this.value);\">\n";
      $disHTML .= " <span class=\"props-inline_title props-notetxt\">px</span>\n";
//      $disHTML .= "</fieldset>\n";
   }
...
//      $disHTML .= " <select id=\"title_position\" onchange=\"saveField('".$_REQUEST['field_id']."', 'toptitle', this.value);\">\n";
      ...
      $disHTML .= " <span class=\"radio_option\" onclick=\"toggle_checkbox('titlepos_top', 'check');saveField('".$_REQUEST['field_id']."', 'titlepos', radiovalue('properties_form', 'title_position'));\">\n";
      ...
      $disHTML .= " </span>\n";
      $disHTML .= " <span class=\"radio_option\" onclick=\"toggle_checkbox('titlepos_left', 'check');saveField('".$_REQUEST['field_id']."', 'titlepos', radiovalue('properties_form', 'title_position'));\">\n";
