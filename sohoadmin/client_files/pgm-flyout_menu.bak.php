...
while($pages_array_ar=mysql_fetch_assoc($menuresult)){
	...
	if(strtolower($pages_array_ar["type"]) == "menu"){
		...
		if($pagelink==startpage()){
			$pagelink = 'http://'.$_SESSION['this_ip'].'/';
		} else {
...
$flyoutmenu .= "<div class=\"navigation\">\n	<ul class=\"nav-bar twelve columns\">\n";
...
$main_textmenu = str_replace("class=\"main\"","",preg_replace('/ | $/','',$main_textmenu));
